...
| M7 — customer acceptance / lead boundary | PENDING | |
| M8 — Sales Orders | PENDING | |
| M9 — Commercial Invoices | PENDING | |
| M10 — payment recording/confirmation | PENDING | |
| M11 — payment allocation | PENDING | |
| M12 — refunds | PENDING | |
| M13 — subscription/license fulfillment | PENDING | |
| M14 — commission policy | PENDING | |
| M15 — commission ledger | PENDING | |
