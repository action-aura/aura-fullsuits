/**
 * Aura Clinic -- Licensing UI (Phase 7 Part G).
 *
 * Self-contained: does not depend on the shared SubsystemApp shell that
 * subsystem-clinic.js expects, because no such shell currently exists
...
(function () {
  ...
  const REASON_MESSAGES = {
    ...
    PRODUCT_MISMATCH: 'This license key is not valid for Aura Clinic.',
  ...
  function renderActivationForm(state) {
    ...
    const detailText = state === 'NOT_CONFIGURED'
      ...
      : 'Enter your Aura Clinic license key to activate this installation.';
    ...
    const input = el('input', {
      ...
      placeholder: 'AURA-CLINIC-XXXX-YYYY-ZZZZ',
    });
