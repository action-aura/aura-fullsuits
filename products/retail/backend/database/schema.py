...
def _migrate_retail_schema(conn):
    ...
    # v9 -> v11 (feat/pos-hold-resume-sale) -- NOT v9 -> v10; v10 belongs to
    # the unmerged feat/shift-cash-drawer branch, not this chain. Appended
    # LAST, same reasoning again -- see the RETAIL_SCHEMA_VERSION v11
    # comment above for the full renumbering/collision story.
