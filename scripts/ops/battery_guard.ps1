...
# ("pause the work when it reaches 17 percent and hibernate the laptop"), and
# 16% on their instruction 2026-09-16 ("arm the battery guard at 16%, at that
# point pause the work then hibernate").
...
while ($true) {
    ...
    if ($b) {
        ...
        if ($discharging -and $pct -le 16) {
            ...
            # checked. 45s costs nothing at 16% -- there is no scenario where a
            # laptop dies in the 45 seconds after reporting 16% -- and it is
